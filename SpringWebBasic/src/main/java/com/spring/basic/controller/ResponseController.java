...
public class ResponseController {
	...
	/*
	 ...
	 스프링에서 제공하는 Model타입의 객체를 활용하여 Jsp 파일과 같은 View 템플릿으로
	 데이터를 전송할 수 있습니다.
	 Model 객체는 기본적으로 Request 객체의 attribute로 설정되어 전송되므로, 
	 기존에 알고 있던 forward 방식의 응답을 생각하면 됩니다. 
	...
	*/
	...
	//2. @ModelAttribute를 사용하여 화면에 데이터 전송 처리
...
//		model.addAttribute("age", age); 할 필요 x
	...
	//데이터를 view 템플릿으로 전달하는model의 역할과 
	//사용자에게 응답하고자 하는 페이지를 지정하는 역할을동시에 진행할 수 있다.
	@GetMapping("/test3")
