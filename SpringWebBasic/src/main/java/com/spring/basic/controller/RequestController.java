...
//빈을 등록해 놔야(객체가 생성되어 있어야) HandlerMapping이 이 클래스의 객체를 검색할 수 있다.
@Controller
@RequestMapping("/request") //컨트롤러 자체의 공통된 URI 맵핑
public class RequestController {
	
	public RequestController() {
		System.out.println("RequestController 생성됨!");
	}
	...
	public String basic() {
		System.out.println("/basic01 요청이 들어옴!");
		return "/request/req-ex01";
	}
