...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>  
    ...
    <script>
        ...
        window.onload = function(){
            // 사용자가 페이지 관련 버튼을 클릭했을 때 (이전, 다음, 1, 2, ...)
            // a태그의 href에 각각 다른 url을 작성해서 요청을 보내기 귀찮다.
            ...
            document.getElementById('pagination').addEventListener('click', e => {
                ...
                // 현재 이벤트가 발생한 요소 (버튼)의 
                // data-pagenum의 값을 얻어서 변수에 저장 dataset 프로퍼티로 쉽게 끌고 올 수 있습니다.
                const value = e.target.dataset.pagenum;
                
                // 페이지 버튼을 감싸고 있는 form 태그를 지목하여
            ...
            const msg = '${msg}';
            if(msg === 'searchFail') alert('검색 결과가 존재하지 않습니다.');
        }
    </script>
