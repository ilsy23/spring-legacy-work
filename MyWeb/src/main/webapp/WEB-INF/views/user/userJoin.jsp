<%@ page language="java" contentType="text/html; charset=UTF-8"
                    ...
                    <form action="/myweb/user/join" method="post" name="joinForm">
                        <div class="form-group"><!--사용자클래스선언-->
                            ...
                            <div class="input-group"><!--input2탭의 input-addon을 가져온다 -->
                                <input type="text" class="form-control" id="userId" name="userId" placeholder="아이디를 (영문포함 8~12자 이상)">
                        ...
                        <div class="form-group email-form">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-addon">
                                    <button id="mail-check-btn" type="button" class="btn btn-primary">이메일인증</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="addrBasic" name="addrBasic" placeholder="기본주소" readonly>
                        </div>
                        <div class="form-group">
    ...
    <script>
        ...
        document.getElementById('idCheckBtn').onclick = function() {
            ...
            */
            ...
            - Promise 객체를 자동으로 리턴ㄴ하여 손쉽게 통신의 응답데이터를
            소비할 수 있게 해 줍니다.
            (Promise: 비동기 통신의 결과 및 통신의 순서를 보장하는 객체)
            - fetch 함수가 리턴하는 Promise 객체는 단순히 응답 JSON 객체가 아닌
            ...
            */
            ...
            // 통신이 성공했다는 것을 먼저 보장받은 후, 서버의 데이터를 꺼내는 콜백 함수를 실행.
            .then(data => {
        ...
        document.querySelector('.mail-check-input').onblur = function(e) {
            ...
            if(inputCode === code){
                ...
                // select 태그에서 초기값을사용자가 선택한 값으로 무조건 설정하는 방법
    ...
    document.getElementById('joinBtn').onclick = function(){
        ...
        id.onkeyup = function() {
            /*
                자바스크립트의 정규표현식 입니다.
                정규표현식: 문자열 내의 특넝 문자 조합을 찾기 위한 패턴입니다.
        ...
        pw.onkeyup = function(){
            var regex = /^[A-Za-z0-9+]{8,16}$/;
             if(regex.test(document.getElementById("userPw").value )) {
                ...
                document.getElementById("msgPw").innerHTML = "비밀번호 형식을 다시 확인해주세요.";
                pwFlag = false;
            }
        }
        /*비밀번호 확인검사*/
