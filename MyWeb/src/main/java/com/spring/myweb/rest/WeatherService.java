...
public class WeatherService {
	...
	public void getShortTermForecast(String area1, String area2) {
		...
		try {
		     ...
		     urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=fFqg7t3Ca%2FDuZGUM%2BxkXNyE7FEoZ6IXTmNA2f%2BIwIrzf2Mm9sqvMtI12%2F1aksoUjsR%2BWYXhp9kVD3rr9bUXqfw%3D%3D"); /*Service Key*/
...
//		     System.out.println(sb.toString());
		     ...
		     // response의 body 키에 해당하는 JSON 데이터를 가져옵니다.
		     JSONObject body = (JSONObject) response.get("body");
		     
		     // body의 items 키에 해당하는 JSON 데이터 중 item 키를 가진 JSON 데이터를 가져옵니다.
